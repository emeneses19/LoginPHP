...
if(isset($_POST["registrar"])){
	...
	if($filas > 0){
		...
		$consultasql = "INSERT INTO usuarios(Nombre,Correo,usuario,password) VALUES ('$nombre', '$correo', '$usuario', '$password_encriptada')";
		$query_mysql = mysqli_query ($conn, $consultasql);
		if($query_mysql > 0){
			echo "<script>
